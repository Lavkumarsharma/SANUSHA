...
export const Sidebar: React.FC = () => {
  ...
  const menuItems = [
    ...
    { label: 'Navigation CMS', href: '/dashboard/navigation', icon: FolderTree },
    { label: 'Announcements CMS', href: '/dashboard/announcement', icon: LayoutTemplate },
    { label: 'Search Experience CMS', href: '/dashboard/search', icon: Search },
