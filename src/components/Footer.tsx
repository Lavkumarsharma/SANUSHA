      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pb-12 border-b border-[#E8E4DA]">
        ...
        <div className="space-y-4 lg:col-span-1">
          ...
          <p className="text-xs text-gray-600 leading-relaxed max-w-xs font-medium">
            Timeless living, crafted with purpose. Designed to empower. Made to last.
          </p>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-xs font-medium text-gray-600">
            ...
            <li><a href="#collections" className="hover:text-[#6C307D] transition-colors">Decor Accents</a></li>
            <li><a href="#collections" className="hover:text-[#6C307D] transition-colors">Vases & Planters</a></li>
            <li><a href="#collections" className="hover:text-[#6C307D] transition-colors">Wall & Art</a></li>
            <li><a href="#collections" className="hover:text-[#6C307D] transition-colors">Textiles & Cushions</a></li>
            <li><a href="#collections" className="hover:text-[#6C307D] transition-colors">Storage & Baskets</a></li>
